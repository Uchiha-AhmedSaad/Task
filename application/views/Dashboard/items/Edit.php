	...
	<div class="content">
		...
		<div class="panel panel-flat">
			...
			<div class="panel-body">
				<?php echo form_open('dashboard/items/update/'.$items->id); ?>
					<div class="row">
						<div class="form-group col-sm-6">
							<label class="form-check-label" >Item Name</label>
							<input type="text" class="form-control" name="item_name" value="<?php echo $items->item_name; ?>" >
						...
						<div class="from-group col-sm-6">
							...
							<input type="number" class="form-control" name="quantity" value="<?php echo $items->quantity; ?>">
					...
					<div class="row">
						<div class="from-group col-sm-12">
							...
							<input type="number" step="0.5" class="form-control" name="price" value="<?php echo $items->price; ?>">
